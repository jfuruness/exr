...
BOOST_PYTHON_MODULE(python_example) // This should match the name of your extension
{
    using namespace boost::python;

    // Expose the Relationships enum
    enum_<Relationships>("Relationships")
    ...
    // Expose the Announcement class
    class_<Announcement>("Announcement", init<const std::string&, const std::vector<int>&, int,
    ...
    // Expose std::vector<int> and std::vector<std::string>
